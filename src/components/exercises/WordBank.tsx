...
export function WordBank({
  ...
  useEffect(() => {
    ...
    const deselectedIds = Array.from(fadingOutWords).filter(
  ...
  return (
    <div className="w-full">
      <div
        className={`flex flex-wrap gap-2 sm:gap-3 p-3 sm:p-4 min-h-[60px] border-2 border-dashed border-neutral-200 dark:border-neutral-700 rounded-lg items-start justify-center ${directionClass}`}
      >
          ...
          return (
            <button
              ...
              className={`
                ...
                ${selected || isFadingOut ? "pointer-events-none" : ""}
            ...
            >
              ...
              <span
                className={`transition-opacity duration-300 ${
                  selected || isFadingOut ? "opacity-0" : "opacity-100"
                }`}
              >
