...
export default function Home() {
  ...
  const totalXP = 0;
  const englishLevel = 0; // Starting level
    ...
    <Screen>
      <Container className="py-8">
        ...
        <div className="lg:hidden">
          ...
          <Link href="/language-road">
            <Card className="text-center cursor-pointer hover:shadow-lg transition-shadow">
              ...
              <Text variant="h2" className="text-yellow-400 mb-1">
                Level {englishLevel}
              </Text>
        ...
        <div className="hidden lg:flex lg:gap-8">
          {/* Left Side - Language Road Widget */}
          <div className="lg:w-80 xl:w-96">
            <div className="sticky top-8 h-screen overflow-y-auto">
